...
namespace Elmah.Io.Client.Extensions.SourceCode.Test
{
    ...
    at Elmah.Io.Client.Extensions.SourceCode.Test.SourceCodeFromPdbExtensionsTest.CanDecorateMessageWithCode() in REPLACE_ME\SourceCodeFromPdbExtensionsTest.cs:line 36
 ...
 ---> System.DivideByZeroException: Attempted to divide by zero.
   ...
   at ConsoleApp53.Program.Main(String[] args) in C:\Users\thoma\source\repos\ConsoleApp53\ConsoleApp53\Program.cs:line 11";
    ...
    at Elmah.Io.Client.Extensions.SourceCode.Test.SourceCodeFromPdbExtensionsTest.<>c.<<Configure>b__5_1>d.CanDecorateMessageWithCode() in REPLACE_ME\SourceCodeFromPdbExtensionsTest.cs:line 36";
        ...
        public void CanDecorateMessageWithCodeFromStackTraceWithDelegate()
        {
            ...
            Assert.That(msg.Code.Contains("REPLACE_ME\\SourceCodeFromPdbExtensionsTest.cs:line 36"));
            ...
            Assert.That(msg.Data.First(d => d.Key == "X-ELMAHIO-CODEFILENAME").Value, Is.EqualTo($"{root.FullName}\\SourceCodeFromPdbExtensionsTest.cs"));
        }
